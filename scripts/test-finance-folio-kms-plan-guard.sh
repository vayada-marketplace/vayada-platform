...
accept diagnostic finance-diagnostic '(.resource_changes[].address) |= ("module.reviewed."+.)' "module-qualified diagnostic addresses"
...
accept post-import finance-post-import '(.resource_changes[].address) |= ("module.reviewed."+.)' "module-qualified post-import addresses"
