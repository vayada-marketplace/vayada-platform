...
case "${mode}" in
  preflight)
    ...
    ;;
  --grant-product-audit-insert|--grant-affiliate-read|--grant-domain-events-append|--grant-jobs-insert|--grant-expense-category-insert|--grant-expense-insert)
    ca_required=true
...
if [[ "${ca_required}" == true ]]; then
  ...
  if [[ "${mode}" == "--grant-identity-runtime" || "${mode}" == "--grant-expense-category-insert" || "${mode}" == "--grant-expense-insert" || "${mode}" == "--grant-affiliate-read" || "${mode}" == "--harden-cluster-database-acl" || "${mode}" == *finance-expense-worker || "${mode}" == *channex-management-worker ]]; then
  ...
  if [[ ( "${mode}" == "--grant-identity-runtime" || "${mode}" == "--grant-expense-category-insert" || "${mode}" == "--grant-expense-insert" || "${mode}" == "--grant-affiliate-read" || "${mode}" == "--harden-cluster-database-acl" ) && "${#ca_payload}" -gt 2100 ]]; then
