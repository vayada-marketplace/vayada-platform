  ...
  finance-steady)
    ...
    jq -e '
      ...
      (($inventory.change.actions==["no-op"] and ($inventory.change.before|norm_inventory_modes)==($inventory.change.after|norm_inventory_modes)) or
       ($inventory.change.actions==["delete","create"] and (($inventory.change.before|stable_inventory|del(.container_definitions))==($inventory.change.after|stable_inventory|del(.container_definitions))) and
